...
docker run -t armr:latest /bin/bash -c "mkdir workspaces && cd workspaces && git clone https://github.com/r-devel/r-dev-env.git && cd r-dev-env && wget https://raw.githubusercontent.com/iaine/time_r/refs/heads/main/time_build_r.sh && chmod +x time_build_r.sh && ./time_build_r.sh && cat /workspaces/r-dev-env/times.txt"
}
